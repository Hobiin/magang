                ...
                echo '
                    ...
                    <div class="row agenda">
                        ...
                        $query2 = mysqli_query($config, "SELECT institusi, nama, alamat, logo FROM tbl_instansi");
                            ...
                            <h5 class="hid"><font color="black"><b>LAPORAN SURAT KELUAR</b></font></h5>
                        <div class="col s20">
                            <p class="warna agenda">Rekapitulasi Surat Keluar dari tanggal <strong>'.indoDate($dari_tanggal).'</strong> sampai dengan tanggal <strong>'.indoDate($sampai_tanggal).'</strong></p>
                        </div>
                    </div>
                    <div id="colres" class="warna cetak">
                        <table class="bordered" id="tbl" width="100%">
                            <thead class="blue lighten-4">
							 ...
							 <tr>
                                    ...
                                    <th width="6%">Tanggal<br/> Surat</th>
									<th width="4%">Nomor Surat</th>
                                    <th width="8%">Kode Klasifikasi</th>
									<th width="5%">Perihal</th>
                                    <th width="8%">Tujuan Surat</th>
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                 echo '
                                    ...
                                    echo '<tr><td colspan="9"><center><p class="add">Tidak ada laporan surat keluar</p></center></td></tr>';
                                } echo '
                            </tbody></table>
                        </div>
                        <br>
                        <br>
                         <div class="col s12">
                            ...
                            <a href="download_excelsk.php?dari='.$dari_tanggal.'&&sampai='.$sampai_tanggal.'" class="btn-large deep-green waves-effect waves-light right">Download Excel <i class="material-icons">cloud_download</i></a>
                        </div>
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=ask" class="judul"><i class="material-icons">report</i> Laporan Surat Keluar<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
