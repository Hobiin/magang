            ...
            if(isset($_REQUEST['act'])){
                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id=l">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    <th width="20%">No. Agenda<br/>Kode Klasifikasi</th>
                                    <th width="30%">Perihal<br/> File</th>
                                    <th width="24%">Asal Surat</th>
                                    <th width="18%">No. Surat<br/>Tgl Surat</th>
                                    <th width="10%">Disposisi<br/>Penerima</th>
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE kode LIKE '%$cari%' ORDER by id_surat DESC LIMIT $curr, 5000");
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                  ...
                                  <tr>
                                    ...
                                    <td>'.$row['disposisi'].'<br/><hr/>'.$row['keterangan'].'</td>
                                    <td>';
                                    ...
                                    if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1){
                                      ...
                                      echo '<a class="btn small blue waves-effect waves-light" href="?page=tsm&act=edit&id_surat='.$row['id_surat'].'">
                                            ...
                                            <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'"    <i class="material-icons">print</i> PRINT</a>
                    ...
                    <!-- Row form END -->';
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk ORDER by id_surat DESC LIMIT $curr, 5000");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
