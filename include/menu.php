...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">school</i> Aplikasi Arsip Surat</a>
                ...
                <div class="logo-side center blue-grey darken-3">
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                echo '<h5=>'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5=>BNN Provinsi NTB</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class=>'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class=>Jl. Lingkar Selatan, Mataram</p>';
                            }
                        }
                    ?>
                </div>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">email</i> Apikasi Arsip Surat</a></li>
            <li><div class="grs"></></li>
