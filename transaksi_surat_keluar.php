                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        <th width="10%">No. Agenda<br/>Kode Klasifikasi</th>
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar WHERE kode LIKE '%$cari%' ORDER by id_surat DESC LIMIT $curr, 5000");
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    <th width="31%">No. Agenda<br/>Kode Klasifikasi</th>
                                    <th width="31%">Perihal<br/> File</th>
                                    <th width="24%">Tujuan</th>
                                    <th width="19%">No. Surat<br/>Tgl Surat</th>
                            ...
                            //script untuk mencari data
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar ORDER by id_surat DESC LIMIT $curr, 5000");
                            if(mysqli_num_rows($query) > 0){
                                $no = 1;
                                while($row = mysqli_fetch_array($query)){
                                  echo '
