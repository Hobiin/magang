                    ...
                    if(!preg_match("/^[a-zA-Z0-9.\/ -]*$/", $no_surat)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $tujuan)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $isi)){
                                ...
                                if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $nkode)){
                                    $_SESSION['kodek'] = 'Form Kode Klasifikasi hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), kurung(), underscore(_), dan(&) persen(%) dan at(@)';
                                echo '<script language="javascript">window.history.back();</script>';
                                } else {
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <textarea id="isi" class="materialize-textarea validate" name="isi" required></textarea>
                                ...
                                ?>
                                <label for="no_agenda">Perihal</label>
                        </div>
                        <div class="input-field col s6">
